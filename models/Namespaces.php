 ...
 *
 * The followings are the available columns in table '{{translations_namespaces}}':
 * @property integer $id
 * @property string $name
 */
class Namespaces extends CActiveRecord
{
	/**
	 ...
	 * @return Namespaces the static model class
	 */
